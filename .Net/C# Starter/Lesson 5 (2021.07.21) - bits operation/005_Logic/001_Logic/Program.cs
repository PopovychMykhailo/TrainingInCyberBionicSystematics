...
namespace Logic
{
    class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine($"{operand1} AND {operand2} = {result}");
            ...
            Console.WriteLine($"{operand1} OR {operand2} = {result}");
            ...
            Console.WriteLine($"{operand1} XOR {operand2} = {result}");
            ...
            Console.WriteLine($"NOT {operand1} = {result}");
            ...
            Console.WriteLine($"~ {operand1} + 1 = {result}");
