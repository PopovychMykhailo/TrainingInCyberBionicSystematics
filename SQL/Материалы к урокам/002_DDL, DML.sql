...
(
	...
	FILENAME = 'D:\DBs\TEST_DB.mdf',       -- Физическое имя БД
...
LOG ON
(
	NAME = 'TEST_DBLog', 				-- Логическое имя файла журнала
	FILENAME = 'D:\DBs\TEST_DB.ldf',       -- Физическое имя журнала бд
...
CREATE DATABASE TEST_DB  -- создание базы данных с параметрами по-умолчанию
